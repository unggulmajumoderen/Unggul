        ...
        {services.map((item: any) => (
          ...
          >
            <div className="relative w-full aspect-[4/3] overflow-hidden bg-gray-100">
              ...
              {/* Floating icon */}
              <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-lg transform scale-100 group-hover:scale-110 transition-transform duration-300 text-green-600">
